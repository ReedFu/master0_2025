...
for data_file in data_files:
    ...
    x = df[df.columns[6]]# Temperature (℃)
    y = df[df.columns[7]]# INP concentration (#/L)
...
plt.savefig("./master0_2025/PAMARCMiP/INP_vs_Temperature_Hartmann_LINA_blank.png", bbox_inches='tight')