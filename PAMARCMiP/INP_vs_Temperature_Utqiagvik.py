...
df = pd.read_table(r"D:\Data\PAMARCMiP\Wex-etal_2019_INP\datasets\Utqiagvik_INP.tab", skiprows=20)
...
plt.savefig("./master0_2025/PAMARCMiP/INP_vs_Temperature_Utqiagvik.png", bbox_inches='tight')