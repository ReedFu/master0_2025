...
for data_file in data_files:
    ...
    y = df[df.columns[5]]-df[df.columns[7]]# net INP concentration (#/L)
...
plt.savefig("./master0_2025/PAMARCMiP/INP_vs_Temperature_Hartmann_LINA_net.png", bbox_inches='tight')