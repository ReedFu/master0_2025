...
df = pd.read_table(r"D:\Data\PAMARCMiP\Wex-etal_2019_INP\datasets\Alert_INP.tab", skiprows=22)
...
plt.savefig("./master0_2025/PAMARCMiP/INP_vs_Temperature_Alert.png", bbox_inches='tight')