### AC3 观测: INP浓度与温度关系图
### 站点: Villum Research Station, Greenland
### 读取一个 tab 数据文件, 绘制散点图
### 时间: 2025-09-20
### 作者：付弘宇
...
df = pd.read_table(r"D:\Data\PAMARCMiP\Wex-etal_2019_INP\datasets\Station_Nord_Villum_INP.tab", skiprows=22)
...
plt.savefig("./master0_2025/PAMARCMiP/INP_vs_Temperature_VRS.png", bbox_inches='tight')