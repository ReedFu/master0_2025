...
for i, temp in enumerate(temperature):
    ...
    for file in p.glob("data_202411*.csv"): #### 修改此处文件名可选择不同时间段的数据 ####
    ...
    data_prp_selected = data_prp[(date >= '2024-11-01') & (date < '2024-12-01')]
    ### 读取日期数据, 为绘图做准备
    x_inp = df_inp['Date']
    ...
    ax1.set_xlabel('Date in November 2024')###
    ### y轴的设置
...
### 保存图片
plt.savefig(r"D:\Coding\master0_2025\Lanzhou_cfdc\202411.png")###