...
for i, temp in enumerate(temperature):
    ...
    for file in p.glob("data_202509*.csv"): #### 修改此处文件名可选择不同时间段的数据 ####
    ...
    data_prp_selected = data_prp[(date >= '2025-09-01') & (date < '2025-10-01')]
    ### 读取日期数据, 为绘图做准备
    x_inp = df_inp['Date']
    ...
    ax1.set_xlabel('Date in September 2025')###
    ### y轴的设置
...
### 保存图片
plt.savefig(rf"D:\Coding\master0_2025\Lanzhou_cfdc\202509.png")###