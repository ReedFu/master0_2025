...
### 读取多个 TXT 文件, 绘制散点图, 散点的颜色表示流量(Qs)
### 时间: 2025-09-06
### 作者：付弘宇
...
c = all_df['Qs']
print(min(c), max(c))
scatter = ax.scatter(x=x, y=y, c=c, cmap="Oranges")

# 添加颜色条
cbar = fig.colorbar(scatter, ax=ax)
cbar.set_label('Qs(LPM)')


#plt.show()
plt.savefig("./master0_2025/FIRE-ACE/INP_Temperature_Qs.png", bbox_inches='tight')